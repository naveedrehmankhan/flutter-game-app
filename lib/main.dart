...
import 'package:game_app/ui/theme/color.dart';
import 'package:game_app/utils/game_logic.dart';
...
class _GameScreenState extends State<GameScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        backgroundColor: Color.fromARGB(255, 125, 169, 245),
        body: Column(
